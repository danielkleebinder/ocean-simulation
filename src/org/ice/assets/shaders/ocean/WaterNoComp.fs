...
void main(void) {
    ...
    vec3 normal = normalize(m_ModelNormalMatrix * (texture(m_NormalsFoldingMap, e_TexCoord.st).xyz*2.0-1.0));
    float folding = texture(m_NormalsFoldingMap, e_TexCoord.st).a*0.0;
